...
module.exports = function (backendBranchName) {
  ...
  // 同步前端代码到 S3
  console.log(`aws s3 sync ${FRONTEND_DEPLOY_REL_PATH} s3://static.easiglobal.com/`)
  const result = execSync(`aws s3 sync ${FRONTEND_DEPLOY_REL_PATH} s3://static.easiglobal.com/`, frontendExecOptions)
  console.log(result)
